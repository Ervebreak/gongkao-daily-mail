...
class Settings:
    ...
    daily_question_multi_candidate_enabled: bool = get_bool("DAILY_QUESTION_MULTI_CANDIDATE_ENABLED", False)
    weekly_material_multi_candidate_enabled: bool = get_bool("WEEKLY_MATERIAL_MULTI_CANDIDATE_ENABLED", False)
